...
// document.addEventListener("DOMContentLoaded", function () {
//     document.querySelectorAll(".explain").forEach((item, index) => {
//         item.addEventListener("click", function () {
//             // すべての .btn から is-btn-active クラスを削除
//             document.querySelectorAll(".explain").forEach(el => el.classList.remove("is-explain-active"));
//             // クリックされた要素に is-btn-active クラスを追加
//             this.classList.add("is-explain-active");
//             // すべての .map-contents から is-contents-active クラスを削除
//             document.querySelectorAll(".answer").forEach(el => el.classList.remove("is-answer-open"));
//             // クリックされた要素の index に対応する .map-contents に is-contents-active クラスを追加
//             document.querySelectorAll(".answer")[index].classList.add("is-answer-open");
//         });
//     });
// });
